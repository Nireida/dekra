...
export class UserFormService {
  getQuestions(): QuestionBase<User>[] {
    return [
      { key: 'username', label: 'Username', controlType: controlType.textbox, required: true, order: 1 },
      { key: 'name', label: 'First Name', controlType: controlType.textbox, required: true, order: 2 },
      { key: 'surnames', label: 'Surnames', controlType: controlType.textbox, required: true, order: 3 },
      { key: 'email', label: 'Email', type: 'email', controlType: controlType.textbox, required: true, order: 4 },
